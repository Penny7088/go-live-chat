...
type TalkRecords struct {
	...
	Sequence   int64     `gorm:"column:sequence;type:int(11);NOT NULL" json:"sequence"`                         // 消息时序ID（消息排序）
	...
	UserID     int       `gorm:"column:user_id;type:bigint(20) unsigned;default:0;NOT NULL" json:"userID"`      // 发送者ID（0:代表系统消息 >0: 用户ID）
	ReceiverID int       `gorm:"column:receiver_id;type:int(11) unsigned;default:0;NOT NULL" json:"receiverID"` // 接收者ID（用户ID 或 群ID）
